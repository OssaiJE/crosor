                  ...
                  <div className="tab-content">
                    <div className="tab-pane active" id="register">
                      ...
                      >
                        ...
                        <div className="row">
                          ...
                          <div className="form-group col-xs-6">
                            <label for="country" className="sr-only"></label>
                    ...
                    <div className="tab-pane" id="login">
                      ...
                      <form name="Login_form" id="Login_form">
                        <div className="row">
                          <div className="form-group col-xs-12">
                            <label for="my-email" className="sr-only">
                              Email
                            </label>
                            <input
                              id="my-email"
                        ...
                        <div className="row">
                          <div className="form-group col-xs-12">
                            <label for="my-password" className="sr-only">
                              Password
                            </label>
                            <input
                              id="my-password"
                ...
                <div className="footer-wrapper">
                  ...
                  <div className="col-md-3 col-sm-3">
                    ...
                    <ul className="contact">
                      <li>
                        <i className="icon ion-ios-telephone-outline"></i>+1
                        (234) 222 0754
                      </li>
                      <li>
                      ...
                      <li>
                        <i className="icon ion-ios-location-outline"></i>228
                        Park Ave S NY, USA
                      </li>
                    </ul>
                  </div>
